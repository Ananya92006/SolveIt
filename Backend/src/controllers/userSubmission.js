...
//         return res.status(400).send("Some field misssing");
...
// })
// //Judge0 code ko submit krwana h
...
// //problem id insertion in userSchama k problemsolved me if it not preesent there
// // ProblemId ko insert karenge userSchema ke problemSolved mein agar submission accepted hua ho tab
...
//         const userId = req.result?._id;
//         const problemId = req.params?.id;
//         const { code, language } = req.body || {};  // <-- fix
